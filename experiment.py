...
# added shell=True
call('rm -rf  _RESULTS_VALIDATION_LL',shell=True)
call(['rm', _RESULTS_VALIDATION_RMSE],shell=True)
call(['rm', _RESULTS_VALIDATION_MC_RMSE],shell=True)
call(['rm', _RESULTS_TEST_LL],shell=True)
call(['rm', _RESULTS_TEST_TAU],shell=True)
call(['rm', _RESULTS_TEST_RMSE],shell=True)
call(['rm', _RESULTS_TEST_MC_RMSE],shell=True)
call(['rm', _RESULTS_TEST_LOG],shell=True)
